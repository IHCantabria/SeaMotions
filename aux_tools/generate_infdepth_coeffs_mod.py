...
if __name__ == "__main__":
    ...
    folder_path = os.path.join(this_path, "0_databases", "0_infinite_water_depth", "Prec_1Em3")
    generate_region_11(folder_path, show_figs=False, show_summary_fig=False)
    generate_region_11_dx(folder_path, show_figs=False, show_summary_fig=False)
