...
from fit_wave_infdepth import fit_residual_region_11_adaptive, fit_residual_region_00_dx_adaptive, fit_residual_region_11_dx_adaptive
...
def generate_region_00_dx(folder_path: str, show_summary_fig=False, show_figs=False)->None:
    # Fit coefficients
    fit_region = fit_residual_region_00_dx_adaptive(folder_path, show_summary_fig=show_summary_fig, show_figs=show_figs)

    # Write coefficients
    write_coeffs_module_adaptive_2d_only_header( fit_region, folder_path, "R00_dX" )
...
if __name__ == "__main__":
    ...
    elif option == "region_00_dx":
        generate_region_00_dx(folder_path, show_figs=False, show_summary_fig=True)
