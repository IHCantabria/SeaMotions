                                            ...
                                            )
{
    ...
    if ( this->_mpi_config->is_root( ) )
    {
        ...
        this->qtf_fs_vel_y_fk_freq          = generate_empty_vector<cuscomplex>( fs_freqs_heads_freq_np );
        this->qtf_fs_vel_z_fk_freq          = generate_empty_vector<cuscomplex>( fs_freqs_heads_freq_np );
                                ...
                                )
{
    ...
    if ( this->_is_qtf_indirect_freq )
    {
        ...
        mkl_free( this->qtf_fs_vel_y_fk_freq        );
        mkl_free( this->qtf_fs_vel_z_fk_freq        );
...
void    SimulationData::storage_qtf_indirect_freq(
                                                    ...
                                                    cuscomplex* qtf_fs_vel_y_fk,
                                                    cuscomplex* qtf_fs_vel_z_fk,
                                                ...
                                                )
{
    if ( this->_mpi_config->is_root( ) )
    {
        ...
        for ( int i=0; i<this->qtf_fs_heads_np; i++ )
        {
            ...
            this->qtf_fs_vel_z_fk_freq[idx1]     = qtf_fs_vel_z_fk[i];
