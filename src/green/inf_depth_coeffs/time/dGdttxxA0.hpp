#ifndef __dGdttxxA0_coeffs_hpp
#define __dGdttxxA0_coeffs_hpp
...
alignas(FLOATING_PRECISION)  static constexpr cusfloat      c[20] = {
                                                                1673.9471545446920118,  // c[0]
                                                                -1.4708926703242469,  // c[1]
                                                                -0.7200439901887421,  // c[2]
                                                                -0.2516804142966294,  // c[3]
                                                                -0.0675331595739408,  // c[4]
                                                                1590.3237229238829968,  // c[5]
                                                                -121.5260437211971407,  // c[6]
                                                                -53.3488256899274802,  // c[7]
                                                                -15.6337506722886133,  // c[8]
                                                                -3.0188906456495488,  // c[9]
                                                                877.8780614805401683,  // c[10]
                                                                -403.1032994910929688,  // c[11]
                                                                154.2341810524806078,  // c[12]
                                                                4.2896780763254014,  // c[13]
                                                                -34.4996955992326662,  // c[14]
                                                                369.2685020759261079,  // c[15]
                                                                -330.4014679447739127,  // c[16]
                                                                -106.7423023140359533,  // c[17]
                                                                -14.4815013890246718,  // c[18]
                                                                4.0962840248958230,  // c[19]
                                                  };
